...
class StochasticPool2DLayer(nn.Module):
    def __init__(self, pool_size=3, maxpool=True, training=False, grid_size=None, **kwargs):
        super(StochasticPool2DLayer, self).__init__()
...
if __name__ == '__main__':
    a = torch.randn(256, 3, 256, 256)
    print(a)
    layer = StochasticPool2DLayer(pool_size=3, maxpool=True, training=True)
    b = layer.forward(a)
    print(b.shape)
    # print(b)